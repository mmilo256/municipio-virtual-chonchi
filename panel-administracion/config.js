export const API_URL = import.meta.env.VITE_API_URL || 'http://localhost:10000/api/admin';
export const SERVER_URL = import.meta.env.VITE_SERVER_URL || 'http://localhost:10000';
