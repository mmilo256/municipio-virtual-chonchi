        ...
        <>
            ...
            <Accordion title="3. Detalles del permiso">
                <div className="grid grid-cols-2 gap-y-1">
                    ...
                    <p><strong>Fecha de inicio:</strong> {formatDate(request?.respuestas?.permissionStartDate)}, {request?.respuestas?.permissionStartTime}</p>
                    <p><strong>Fecha de término:</strong> {formatDate(request?.respuestas?.permissionEndDate)}, {request?.respuestas?.permissionEndTime}</p>
