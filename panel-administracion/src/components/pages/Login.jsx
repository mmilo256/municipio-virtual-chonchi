...
const Login = () => {
  ...
  return (
    <div
      className="min-h-dvh"
      style={{ backgroundImage: `url(${bg})`, backgroundSize: 'cover', backgroundPosition: 'top' }}
    >
      <div className="bg-slate-900 min-h-dvh bg-opacity-85 flex items-center justify-center">
        <form
          onSubmit={handleLogin}
          name="login-form"
          className="bg-cyan-200 bg-opacity-20 text-white p-8 rounded-xl"
        >
          ...
          <p className="mt-4 text-center text-sm text-slate-300">
            ¿Problemas para acceder? <br /> Contacte al administrador del sistema
          </p>
        </form>
      </div>
      <ToastContainer />
