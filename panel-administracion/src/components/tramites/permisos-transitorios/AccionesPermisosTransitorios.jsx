...
const AccionesPermisosTransitorios = ({
  ...
  const generarDecretoButton = (
    <button
      onClick={() => {
        navigate('generar-decreto', { state: { request } });
      }}
  ...
  const descargarDecretoSinFirmarButton = (
    <button
      onClick={() => {
        abrirDecreto(decretos?.decretoSinFirma.id);
      }}
  ...
  const descargarDecretoFirmadoButton = (
    <button
      onClick={() => {
        abrirDecreto(decretos?.decretoFirmado.id);
      }}
