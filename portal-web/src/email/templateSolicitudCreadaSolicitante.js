const templateSolicitudCreadaSolicitante = (
  nombreUsuario,
  nombreTramite,
  idSolicitud,
  fechaSolicitud,
        ...
        >
          ...
          <div style="padding: 0 24px 32px 24px; font-family: Arial, Helvetica, sans-serif">
            ...
            <div style="margin-top: 8px; font-size: 14px; line-height: 1.6; color: #334155">
              Te confirmamos que tu solicitud fue enviada correctamente a través de
              <span style="font-weight: 700">Municipio Virtual Chonchi</span>.
            </div>
            ...
            >
              ...
              <ul
                ...
                "
              >
                <li style="margin: 0 0 6px 0">Tu solicitud será revisada por la municipalidad.</li>
                <li style="margin: 0 0 6px 0">
                  Si es necesario, te contactaremos por correo o teléfono.
                </li>
                <li style="margin: 0">
                  Puedes consultar el estado de tu solicitud en la plataforma.
                </li>
              </ul>
            </div>
...
export default templateSolicitudCreadaSolicitante;
