      ...
      <div className="mt-4 text-sm">
        ...
        <Accordion title="2. Datos de la organización">
          <div className="grid grid-cols-2 pl-8">
            ...
            <div className={itemStyles}>
              <p>
                <strong>RUT de la organización </strong>
              </p>
              <p>{orgRut}</p>
            </div>
            <div className={itemStyles}>
        ...
        <Accordion title="4. Detalles del permiso">
          <div className="grid grid-cols-2 pl-8">
            ...
            <div className={itemStyles}>
              <p>
                <strong>Lugar de realización </strong>
              </p>
              <p>{permissionPlace}</p>
            </div>
            <div className={itemStyles}>
              ...
              <p>
                {formatDate(permissionStartDate)} a las {permissionStartTime}
              </p>
            </div>
            <div className={itemStyles}>
              <p>
              ...
              <p>
                {formatDate(permissionEndDate)} a las {permissionEndTime}
              </p>
            </div>
            <div className={itemStyles}>
              <p>
            ...
            <div className={itemStyles}>
              <p>
                <strong>Destino de los fondos </strong>
              </p>
        ...
        <Accordion title="5. Antecedentes">
          <ul className="list-disc list-inside pl-8 text-blue-700 underline">
            ...
            {
              <li>
                <a href={URL.createObjectURL(docsValues.docCI)} target="_blank" rel="noreferrer">
            ...
            {
              <li>
                <a href={URL.createObjectURL(docsValues.docRutTributario)} target="_blank" rel="noreferrer">
                  RUT tributario
                </a>
              </li>
            }
            {
              <li>
                <a
                  href={URL.createObjectURL(docsValues.docCertificadoAntecedentes)}
            ...
            }
            {
              <li>
                <a
                  href={URL.createObjectURL(docsValues.docVigenciaPersonaJuridica)}
                  target="_blank" rel="noreferrer"
                >
            ...
            {
              <li>
                <a href={URL.createObjectURL(docsValues.docOcupacionRecinto)} target="_blank" rel="noreferrer">
            ...
            {
              <li>
                <a href={URL.createObjectURL(docsValues.docDeclaracionJurada)} target="_blank" rel="noreferrer">
            ...
            {
              <li>
                <a href={URL.createObjectURL(docsValues.docFirmaPresidente)} target="_blank" rel="noreferrer">
