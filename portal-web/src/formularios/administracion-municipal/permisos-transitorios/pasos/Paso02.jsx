...
const Paso02 = ({ values, onChange }) => {
  ...
  return (
    <div className="flex flex-col gap-2">
      <FormField id="orgName" label="Nombre o razón social">
        <InputText
      ...
      <FormField id="orgAddress" label="Dirección">
        <InputText
      ...
      <FormField id="orgEmail" label="Correo electrónico">
        <InputText
      ...
      <FormField id="orgPhone" label="Teléfono">
        <InputText value={values.orgPhone} onChange={onChange} placeholder="Ej: 912345678" />
      </FormField>
      <FormField id="orgType" label="Tipo de organización">
