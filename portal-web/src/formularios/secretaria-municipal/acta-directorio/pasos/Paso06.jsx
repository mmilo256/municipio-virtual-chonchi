  ...
  return (
    <div className="text-sm">
      ...
      <Accordion title="5. Antecedentes">
        <ul className="list-disc list-inside pl-2 space-y-3 text-blue-700 underline">
          <a
            target="_blank"
            href={docCI && URL.createObjectURL(docCI)}
          ...
          <a
            target="_blank"
            href={docRutTributario && URL.createObjectURL(docRutTributario)}
            className="block text-left"
            rel="noreferrer"
          >
            RUT tributario
          ...
          <a
            target="_blank"
            href={docVigenciaPersonaJuridica && URL.createObjectURL(docVigenciaPersonaJuridica)}
            className="block text-left"
            rel="noreferrer"
          >
          ...
          <a
            target="_blank"
            href={docOcupacionRecinto && URL.createObjectURL(docOcupacionRecinto)}
            className="block text-left"
            rel="noreferrer"
          >
          ...
          <a
            target="_blank"
            href={docDeclaracionJurada && URL.createObjectURL(docDeclaracionJurada)}
            className="block text-left"
            rel="noreferrer"
          >
          ...
          <a
            target="_blank"
            href={docCertificadoAntecedentes && URL.createObjectURL(docCertificadoAntecedentes)}
            className="block text-left"
            rel="noreferrer"
          >
          ...
          <a
            target="_blank"
            href={docFirmaPresidente && URL.createObjectURL(docFirmaPresidente)}
            className="block text-left"
            rel="noreferrer"
          >
