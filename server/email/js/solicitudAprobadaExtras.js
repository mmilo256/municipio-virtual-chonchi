export const plantillaSolicitudAprobadaExtras = (data) => {
  return `
  <!doctype html>
<html lang="es">
  <head>
    ...
    <title>Remite copia de documento - Municipio Virtual Chonchi</title>
  </head>
      ...
      <div style="max-width: 560px; margin: 0 auto">
        ...
        >
          ...
          <div style="padding: 0 24px 32px 24px; font-family: Arial, Helvetica, sans-serif">
            <!-- Saludo -->
            <div style="font-size: 18px; font-weight: 700; color: #0f172a">Estimada/o,</div>

            <!-- Texto principal -->
            <div style="margin-top: 12px; font-size: 14px; line-height: 1.6; color: #334155">
              Junto con saludar, se remite para su conocimiento copia del documento emitido por la
              Ilustre Municipalidad de Chonchi, asociado a la aprobación de la solicitud
              correspondiente al trámite <strong>${data.nombreTramite}</strong>.
            </div>
            ...
            >
              <div
                style="font-size: 12px; font-weight: 700; letter-spacing: 0.04em; color: #1e40af"
              >
                DOCUMENTO REMITIDO PARA CONOCIMIENTO
              </div>

              <div style="margin-top: 8px; font-size: 14px; color: #1e3a8a; line-height: 1.6">
                El documento adjunto se envía a modo de comunicación oficial, según corresponda al
                trámite aprobado y a las coordinaciones necesarias con otras instituciones.
              </div>
            </div>
            ...
            <!-- Cierre -->
            <div style="margin-top: 24px; font-size: 14px; line-height: 1.6; color: #334155">
              Sin otro particular, saluda atentamente,
            </div>

            <div style="margin-top: 12px; font-size: 14px; font-weight: 700; color: #0f172a">
