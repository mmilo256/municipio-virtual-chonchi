export const plantillaSolicitudRechazadaSolicitante = (data) => {
  return `
  <!doctype html>
<html lang="es">
  <head>
    ...
    <title>Solicitud rechazada - Municipio Virtual Chonchi</title>
  </head>
        ...
        >
          ...
          <div style="padding: 0 24px 32px 24px; font-family: Arial, Helvetica, sans-serif">
            ...
            <div style="margin-top: 12px; font-size: 14px; line-height: 1.6; color: #334155">
              ...
              <strong>${data.nombreTramite}</strong> ha sido <strong>rechazada</strong> por la Ilustre
            ...
            >
              ...
              <div style="margin-top: 8px; font-size: 14px; color: #991b1b; line-height: 1.6">
                ${data.motivoRechazo}
              </div>
            </div>
            ...
            >
              ...
              >
                <li style="margin: 0 0 6px 0">
                  Revise cuidadosamente el motivo indicado anteriormente.
                </li>

                <li style="margin: 0 0 6px 0">
                  Dependiendo del trámite, podrá realizar una nueva solicitud corrigiendo los
