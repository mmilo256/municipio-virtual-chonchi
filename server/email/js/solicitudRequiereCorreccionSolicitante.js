export const plantillaSolicitudRequiereCorreccionSolicitante = (data) => {
  return `
  <!doctype html>
<html lang="es">
  <head>
    ...
    <title>Solicitud requiere corrección - Municipio Virtual Chonchi</title>
  </head>
        ...
        >
          ...
          <div style="padding: 0 24px 32px 24px; font-family: Arial, Helvetica, sans-serif">
            <div style="font-size: 18px; font-weight: 700; color: #0f172a">
              Estimada/o ${data.nombreSolicitante},
            </div>
            ...
            <div style="margin-top: 12px; font-size: 14px; line-height: 1.6; color: #334155">
              ...
              <strong>${data.nombreTramite}</strong> fue revisada por la Ilustre Municipalidad de Chonchi
              y requiere una corrección para continuar con su tramitación.
            </div>
            ...
            >
              <div
                style="font-size: 12px; font-weight: 700; letter-spacing: 0.04em; color: #92400e"
              >
                SOLICITUD REQUIERE CORRECCIÓN
              </div>

              <div style="margin-top: 8px; font-size: 14px; color: #78350f; line-height: 1.6">
                La solicitud presenta información incompleta, incorrecta o documentos que deben ser
                corregidos. Para evitar retrasos, ingrese al portal y realice la corrección
                solicitada.
              </div>
            </div>
            ...
            >
              <div
                style="font-size: 12px; font-weight: 700; letter-spacing: 0.04em; color: #9a3412"
              >
                OBSERVACIÓN DEL FUNCIONARIO
              </div>

              <div style="margin-top: 8px; font-size: 14px; color: #7c2d12; line-height: 1.6">
                ${data.observacion}
              </div>
            </div>
            ...
            >
              ...
              <ul
                ...
                "
              >
                <li style="margin: 0 0 6px 0">Ingrese al portal de Municipio Virtual Chonchi.</li>
                <li style="margin: 0 0 6px 0">
                  Revise la observación indicada por el funcionario.
                </li>
                <li style="margin: 0 0 6px 0">Corrija la información o documentos solicitados.</li>
                <li style="margin: 0">
                  Una vez enviada la corrección, la solicitud será revisada nuevamente.
                </li>
              </ul>
            </div>
